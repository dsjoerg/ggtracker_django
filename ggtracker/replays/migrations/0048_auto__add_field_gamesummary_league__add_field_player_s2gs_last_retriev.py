...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GameSummary.league'
        db.add_column('replays_gamesummary', 'league', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'Player.s2gs_last_retrieved_at'
        db.add_column('replays_player', 's2gs_last_retrieved_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GameSummary.league'
        db.delete_column('replays_gamesummary', 'league')

        # Deleting field 'Player.s2gs_last_retrieved_at'
        db.delete_column('replays_player', 's2gs_last_retrieved_at')
    ...
    models = {
        ...
        'replays.gamesummary': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'league': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'replays.player': {
            ...
            's2gs_last_retrieved_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
