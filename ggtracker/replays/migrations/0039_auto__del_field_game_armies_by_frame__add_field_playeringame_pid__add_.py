...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Game.armies_by_frame'
        db.delete_column('replays_game', 'armies_by_frame')

        # Adding field 'PlayerInGame.pid'
        db.add_column('replays_playeringame', 'pid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'PlayerInGame.armies_by_frame'
        db.add_column('replays_playeringame', 'armies_by_frame', self.gf('django.db.models.fields.CharField')(max_length=1000000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Game.armies_by_frame'
        db.add_column('replays_game', 'armies_by_frame', self.gf('django.db.models.fields.CharField')(max_length=5000000, null=True, blank=True), keep_default=False)

        # Deleting field 'PlayerInGame.pid'
        db.delete_column('replays_playeringame', 'pid')

        # Deleting field 'PlayerInGame.armies_by_frame'
        db.delete_column('replays_playeringame', 'armies_by_frame')
