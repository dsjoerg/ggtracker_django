...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.upload_time'
        db.add_column('replays_game', 'upload_time', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
        for game in orm.Game.objects.all():
            game.upload_time = game.game_time
            game.save()


    def backwards(self, orm):
        
        # Deleting field 'Game.upload_time'
        db.delete_column('replays_game', 'upload_time')
