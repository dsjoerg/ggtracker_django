...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.subdomain'
        db.add_column('replays_game', 'subdomain', self.gf('django.db.models.fields.CharField')(default='', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.subdomain'
        db.delete_column('replays_game', 'subdomain')
