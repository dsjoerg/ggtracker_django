...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Game.hash'
        db.delete_column('replays_game', 'hash')

        # Adding field 'Game.md5hash'
        db.add_column('replays_game', 'md5hash', self.gf('django.db.models.fields.CharField')(default='nohash', max_length=32, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Game.hash'
        db.add_column('replays_game', 'hash', self.gf('django.db.models.fields.CharField')(default='nohash', max_length=32, db_index=True), keep_default=False)
