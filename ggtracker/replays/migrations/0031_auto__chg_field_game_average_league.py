...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.average_league'
        db.alter_column('replays_game', 'average_league', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Game.average_league'
        db.alter_column('replays_game', 'average_league', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'replays.game': {
            ...
            'average_league': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
