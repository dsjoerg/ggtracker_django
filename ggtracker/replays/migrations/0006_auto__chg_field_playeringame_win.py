...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlayerInGame.win'
        db.alter_column('replays_playeringame', 'win', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PlayerInGame.win'
        db.alter_column('replays_playeringame', 'win', self.gf('django.db.models.fields.BooleanField')())
