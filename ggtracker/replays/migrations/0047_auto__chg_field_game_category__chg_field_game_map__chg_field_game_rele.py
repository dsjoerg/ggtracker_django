...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.category'
        db.alter_column('replays_game', 'category', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Game.map'
        db.alter_column('replays_game', 'map_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Map'], null=True))

        # Changing field 'Game.release_string'
        db.alter_column('replays_game', 'release_string', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Game.replay'
        db.alter_column('replays_game', 'replay_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Replay'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Game.category'
        raise RuntimeError("Cannot reverse this migration. 'Game.category' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Game.map'
        raise RuntimeError("Cannot reverse this migration. 'Game.map' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Game.release_string'
        raise RuntimeError("Cannot reverse this migration. 'Game.release_string' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Game.replay'
        raise RuntimeError("Cannot reverse this migration. 'Game.replay' and its values cannot be restored.")
    ...
    models = {
        ...
        'replays.game': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['replays.Map']", 'null': 'True'}),
            'processed_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'release_string': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'replay': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['replays.Replay']", 'null': 'True'}),
            ...
            'winning_team': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'replays.gamesummary': {
