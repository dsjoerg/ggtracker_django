...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('replays_player', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Player.region'
        db.alter_column('replays_player', 'region', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Player.name'
        raise RuntimeError("Cannot reverse this migration. 'Player.name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Player.region'
        raise RuntimeError("Cannot reverse this migration. 'Player.region' and its values cannot be restored.")
