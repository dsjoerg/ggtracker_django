...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerInGame.color'
        db.add_column('replays_playeringame', 'color', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlayerInGame.color'
        db.delete_column('replays_playeringame', 'color')
