...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('replays_game', 'game_type', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('replays_game', 'game_type')
