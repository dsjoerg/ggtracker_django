...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.sc2ranks_info'
        db.add_column('replays_player', 'sc2ranks_info', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True), keep_default=False)

        # Adding field 'Player.sc2ranks_retrieved'
        db.add_column('replays_player', 'sc2ranks_retrieved', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.sc2ranks_info'
        db.delete_column('replays_player', 'sc2ranks_info')

        # Deleting field 'Player.sc2ranks_retrieved'
        db.delete_column('replays_player', 'sc2ranks_retrieved')
