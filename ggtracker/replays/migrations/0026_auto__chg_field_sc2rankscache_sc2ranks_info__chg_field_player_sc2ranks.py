...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sc2RanksCache.sc2ranks_info'
        db.alter_column('replays_sc2rankscache', 'sc2ranks_info', self.gf('django.db.models.fields.CharField')(max_length=50000, null=True))

        # Changing field 'Player.sc2ranks_info'
        db.alter_column('replays_player', 'sc2ranks_info', self.gf('django.db.models.fields.CharField')(max_length=50000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Sc2RanksCache.sc2ranks_info'
        db.alter_column('replays_sc2rankscache', 'sc2ranks_info', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Player.sc2ranks_info'
        db.alter_column('replays_player', 'sc2ranks_info', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))
