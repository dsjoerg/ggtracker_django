...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerLeague'
        db.create_table('replays_playerleague', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Player'])),
            ('num_players', self.gf('django.db.models.fields.IntegerField')()),
            ('is_random', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_ffa', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('league', self.gf('django.db.models.fields.IntegerField')()),
            ('rank', self.gf('django.db.models.fields.IntegerField')()),
            ('is_best', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('replays', ['PlayerLeague'])


    def backwards(self, orm):
        
        # Deleting model 'PlayerLeague'
        db.delete_table('replays_playerleague')
    ...
    models = {
        ...
        'replays.playerleague': {
            ...
            'is_ffa': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
