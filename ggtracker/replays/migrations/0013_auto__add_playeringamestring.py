...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerInGameString'
        db.create_table('replays_playeringamestring', (
            ...
            ('stat_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('replays', ['PlayerInGameString'])


    def backwards(self, orm):
        
        # Deleting model 'PlayerInGameString'
        db.delete_table('replays_playeringamestring')
