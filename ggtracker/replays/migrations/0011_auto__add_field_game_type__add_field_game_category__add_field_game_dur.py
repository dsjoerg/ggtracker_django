...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.type'
        db.add_column('replays_game', 'type', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=255), keep_default=False)

        # Adding field 'Game.category'
        db.add_column('replays_game', 'category', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=255), keep_default=False)

        # Adding field 'Game.duration_seconds'
        db.add_column('replays_game', 'duration_seconds', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.type'
        db.delete_column('replays_game', 'type')

        # Deleting field 'Game.category'
        db.delete_column('replays_game', 'category')

        # Deleting field 'Game.duration_seconds'
        db.delete_column('replays_game', 'duration_seconds')
