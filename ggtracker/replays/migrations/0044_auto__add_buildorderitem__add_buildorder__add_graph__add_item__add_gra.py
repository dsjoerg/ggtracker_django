...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BuildOrderItem'
        db.create_table('replays_buildorderitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('build_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.BuildOrder'])),
            ('built_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Item'])),
            ('build_seconds', self.gf('django.db.models.fields.IntegerField')()),
            ('supply', self.gf('django.db.models.fields.IntegerField')()),
            ('total_supply', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('replays', ['BuildOrderItem'])

        # Adding model 'BuildOrder'
        db.create_table('replays_buildorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('replays', ['BuildOrder'])

        # Adding model 'Graph'
        db.create_table('replays_graph', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('replays', ['Graph'])

        # Adding model 'Item'
        db.create_table('replays_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
        ))
        db.send_create_signal('replays', ['Item'])

        # Adding model 'GraphPoint'
        db.create_table('replays_graphpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('graph', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Graph'])),
            ('graph_seconds', self.gf('django.db.models.fields.IntegerField')()),
            ('graph_value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('replays', ['GraphPoint'])

        # Adding model 'PlayerSummary'
        db.create_table('replays_playersummary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('build_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.BuildOrder'])),
            ('army_graph', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['replays.Graph'])),
            ('income_graph', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['replays.Graph'])),
            ('resources', self.gf('django.db.models.fields.IntegerField')()),
            ('units', self.gf('django.db.models.fields.IntegerField')()),
            ('structures', self.gf('django.db.models.fields.IntegerField')()),
            ('overview', self.gf('django.db.models.fields.IntegerField')()),
            ('average_unspent_resources', self.gf('django.db.models.fields.IntegerField')()),
            ('resource_collection_rate', self.gf('django.db.models.fields.IntegerField')()),
            ('workers_created', self.gf('django.db.models.fields.IntegerField')()),
            ('units_trained', self.gf('django.db.models.fields.IntegerField')()),
            ('killed_unit_count', self.gf('django.db.models.fields.IntegerField')()),
            ('structures_built', self.gf('django.db.models.fields.IntegerField')()),
            ('structures_razed_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('replays', ['PlayerSummary'])


    def backwards(self, orm):
        
        # Deleting model 'BuildOrderItem'
        db.delete_table('replays_buildorderitem')

        # Deleting model 'BuildOrder'
        db.delete_table('replays_buildorder')

        # Deleting model 'Graph'
        db.delete_table('replays_graph')

        # Deleting model 'Item'
        db.delete_table('replays_item')

        # Deleting model 'GraphPoint'
        db.delete_table('replays_graphpoint')

        # Deleting model 'PlayerSummary'
        db.delete_table('replays_playersummary')
    ...
    models = {
        ...
        'replays.gamesummary': {
            ...
            'game_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['replays.Game']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
