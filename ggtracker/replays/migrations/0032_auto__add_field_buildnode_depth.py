...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuildNode.depth'
        db.add_column('replays_buildnode', 'depth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BuildNode.depth'
        db.delete_column('replays_buildnode', 'depth')
