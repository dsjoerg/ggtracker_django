...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IdentifiedBuild.race'
        db.add_column('replays_identifiedbuild', 'race', self.gf('django.db.models.fields.CharField')(default='p', max_length=1, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IdentifiedBuild.race'
        db.delete_column('replays_identifiedbuild', 'race')
