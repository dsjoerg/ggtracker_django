...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerInGameString.player_in_game'
        db.add_column('replays_playeringamestring', 'player_in_game', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['replays.PlayerInGame']), keep_default=False)

        # Deleting field 'PlayerInGameStat.pig'
        db.delete_column('replays_playeringamestat', 'pig_id')

        # Adding field 'PlayerInGameStat.player_in_game'
        db.add_column('replays_playeringamestat', 'player_in_game', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['replays.PlayerInGame']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PlayerInGameString.pig'
        raise RuntimeError("Cannot reverse this migration. 'PlayerInGameString.pig' and its values cannot be restored.")

        # Deleting field 'PlayerInGameString.player_in_game'
        db.delete_column('replays_playeringamestring', 'player_in_game_id')

        # User chose to not deal with backwards NULL issues for 'PlayerInGameStat.pig'
        raise RuntimeError("Cannot reverse this migration. 'PlayerInGameStat.pig' and its values cannot be restored.")
