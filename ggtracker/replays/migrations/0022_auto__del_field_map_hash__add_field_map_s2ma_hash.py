...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Map.s2ma_hash'
        db.add_column('replays_map', 's2ma_hash', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Map.s2ma_hash'
        db.delete_column('replays_map', 's2ma_hash')
