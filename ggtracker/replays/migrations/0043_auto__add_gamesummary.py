...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameSummary'
        db.create_table('replays_gamesummary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('s2gs_hash', self.gf('django.db.models.fields.CharField')(max_length=80, db_index=True)),
            ('realm', self.gf('django.db.models.fields.CharField')(max_length=2, db_index=True)),
            ('game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.Game'], null=True, blank=True)),
            ('first_seen_at', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('first_retrieved_at', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal('replays', ['GameSummary'])


    def backwards(self, orm):
        # Deleting model 'GameSummary'
        db.delete_table('replays_gamesummary')
