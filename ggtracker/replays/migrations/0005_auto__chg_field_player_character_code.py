...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.character_code'
        db.alter_column('replays_player', 'character_code', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Player.character_code'
        db.alter_column('replays_player', 'character_code', self.gf('django.db.models.fields.IntegerField')(default=0))
