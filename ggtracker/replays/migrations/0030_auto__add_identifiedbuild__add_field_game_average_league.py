...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IdentifiedBuild'
        db.create_table('replays_identifiedbuild', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buildnode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['replays.BuildNode'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('replays', ['IdentifiedBuild'])

        # Adding field 'Game.average_league'
        db.add_column('replays_game', 'average_league', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'IdentifiedBuild'
        db.delete_table('replays_identifiedbuild')

        # Deleting field 'Game.average_league'
        db.delete_column('replays_game', 'average_league')
    ...
    models = {
        ...
        'replays.game': {
            ...
            'average_league': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
